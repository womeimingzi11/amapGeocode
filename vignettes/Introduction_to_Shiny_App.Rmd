...
Starting from version 0.9.0, `amapGeocode` includes a built-in Shiny application (`amap_gui()`) that provides a user-friendly graphical interface for all major package functions. Version 1.0.0 significantly enhances this app with modular architecture, interactive maps, and administrative region search.
...
### 3. Administrative Regions (New in v1.0.0)
...
### 5. Interactive Map (New in v1.0.0)
